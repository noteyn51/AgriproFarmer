            ...
            google.maps.event.addListener(
              ...
              function (polygon) {
                ...
                function cal(patch) {
                  ...
                  // ตารางเมตร
                  var areaM2 =
                    google.maps.geometry.spherical.computeArea(patch);
                  // เอเคอร์
    ...
    function (
        ...
        if ($scope.model.date && $scope.model.time) {
          function n() {
            var confirm = $mdDialog
              ...
              .textContent("บันทึกข้อมูลการเพาะปลูกใช่หรือไม่ ?")
      ...
      $scope.tempData = [
        ...
        },
        {
          ...
          desc: "ความเข็มแสง",
          val: null,
          url: "img/iconOP/5.png",
          um: "lux,lx",
          style: {
            height: "32px",
            width: "32px",
            "background-image": 'url("../img/iconOP/5.png")',
            "background-position": "center",
            "background-repeat": "no-repeat",
            "background-size": "cover",
          },
      ...
      vm.add = function (e, i) {
        if ($scope.ophistAdd.includes(e.code)) {
          ...
          Service.toast("เพิ่มการบันทึก " + e.desc + " แล้ว", "info", "bottom");
        }
